  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          "Premium plywood, hardware, bathroom accessories, LED mirrors and power tools under one roof.",
      },
      {
        property: "og:url",
        content: "/",
  ...
  return (
    <>
      ...
      <section className="relative isolate">
        ...
        <div
          className="bg-hero-overlay absolute inset-0 -z-10"
          aria-hidden
        />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-muted-foreground">
              <p>
                {websiteSettings?.business_name || site.name} supplies
                quality materials, fittings and tools to homeowners,
                carpenters, furniture manufacturers, interior designers,
                architects, contractors, builders, modular kitchen
