  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: `Project Solutions — ${site.name}` },
      {
        ...
        content: "Everything needed for kitchens, wardrobes, bathrooms, doors and workshops in one place.",
      },
    ...
    <>
      <section className="bg-walnut-deep py-16 text-primary-foreground lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <h1 className="mt-3 font-display text-4xl sm:text-5xl">Materials Matched to Your Project</h1>
          <p className="mt-4 max-w-2xl text-primary-foreground/75">
            Tell us what you are building and we will put together the boards, fittings, accessories and
            tools it needs.
          </p>
        </div>
      </section>
          ...
          {solutions.map((s) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Button variant="ghost" className="mt-4 px-0" onClick={() => openQuote(s.title)}>
      ...
      <section className="bg-walnut-gradient py-16 text-primary-foreground">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
          <SectionHeading eyebrow="Let's Plan It" title="Share your requirement list" />
          <p className="mt-4 text-primary-foreground/80">
            Send a room-wise list or a site drawing and we will suggest suitable materials and fittings.
          </p>
